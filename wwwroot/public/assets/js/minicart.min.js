		...
		11: [
			function (a, b) {
				...
				b.exports = {
					...
					BN: 'minicart1_AddToCart_WPS_US',
					KEYUP_TIMEOUT: 500,
					SHOWING_CLASS: 'minicart1-showing',
					REMOVE_CLASS: 'minicart1-remove',
					CLOSER_CLASS: 'minicart1-closer',
					QUANTITY_CLASS: 'minicart1-quantity',
					ITEM_CLASS: 'minicart1-item',
					ITEM_CHANGED_CLASS: 'minicart1-item-changed',
					SUBMIT_CLASS: 'minicart1-submit',
					DATA_IDX: 'data-minicart1-idx',
				}
			},
			{},
		],
		12: [
			function (a, b) {
				...
				;(i.render = function (a) {
					...
					'undefined' == typeof window
						? (b.exports = i)
						: (window.paypal1 || (window.paypal1 = {}),
						  (window.paypal1.minicart1 = i))
			},
